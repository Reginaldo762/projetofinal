...
if(isset($_POST['submit'])){
    ...
    $CPFprestador = $_POST['CPFprestador'];
    $Nome = $_POST['Nome'];
    $RG = $_POST['RG'];
    ...
    $result = mysqli_query($conn, "INSERT INTO prestador(CPFprestador, Nome, RG, Fone, email, uf) 
    VALUES ('$CPFprestador', '$Nome', '$RG', '$Fone', '$email', '$uf')");
...
<body>
    ...
    <div class="container-log">
        ...
        <div class="form">
            <form action="prestadores.php" method="post">
                ...
                <div class="input-group">
                    ...
                    <div class="input-box">
                        <label for="CPFprestador">CPF</label>
                        <input id="CPFprestador" type="text" name="CPFprestador" placeholder="Digite seu CPF" required>
                    </div>
                    <div class="input-box">
